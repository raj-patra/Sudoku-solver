# -*- coding: utf-8 -*-
"""
Modified on Mon Oct 28 12:44:16 2019
...
def printSudoku(sudoku):
    ...
    r1 = np.array(row1); r1 = np.expand_dims(r1, axis=0)
    r2 = np.array(row2); r2 = np.expand_dims(r2, axis=0)
    sud = np.append(r1,r2,axis=0)
    
    r3 = np.array(row3); r3 = np.expand_dims(r3, axis=0)
    sud = np.append(sud,r3,axis=0)
    
    r4 = np.array(row4); r4 = np.expand_dims(r4, axis=0)
    sud = np.append(sud,r4,axis=0)
    
    r5 = np.array(row5); r5 = np.expand_dims(r5, axis=0)
    sud = np.append(sud,r5,axis=0)
    
    r6 = np.array(row6); r6 = np.expand_dims(r6, axis=0)
    sud = np.append(sud,r6,axis=0)
    
    r7 = np.array(row7); r7 = np.expand_dims(r7, axis=0)
    sud = np.append(sud,r7,axis=0)
    
    r8 = np.array(row8); r8 = np.expand_dims(r8, axis=0)
    sud = np.append(sud,r8,axis=0)
    
    r9 = np.array(row9); r9 = np.expand_dims(r9, axis=0)
    sud = np.append(sud,r9,axis=0)
